...
//+kubebuilder:rbac:groups=argoproj.extensions.io,resources=argosupports,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=argoproj.extensions.io,resources=argosupports/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=argoproj.extensions.io,resources=argosupports/finalizers,verbs=update
...
func (r *ArgoSupportReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&argoprojextensionsiov1alpha1.ArgoSupport{}).
		Complete(r)
}
